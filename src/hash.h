...
inline uint256 pepe_hash(const T1 pbegin, const T1 pend, const uint256 PrevBlockHash)
{
    ...
    sph_sha256(&ctx_sha256, static_cast<const void*>(&hash[4]), 64);
    sph_sha256_close(&ctx_sha256, static_cast<void*>(&hash[5]));

    sph_sha256_init(&ctx_sha256);
    sph_sha256(&ctx_sha256, static_cast<const void*>(&hash[5]), 64);
    sph_sha256_close(&ctx_sha256, static_cast<void*>(&hash[6]));

    sph_sha256_init(&ctx_sha256);
    sph_sha256(&ctx_sha256, static_cast<const void*>(&hash[6]), 64);
    sph_sha256_close(&ctx_sha256, static_cast<void*>(&hash[7]));
