...
pkgdatadir = $(datadir)/PEPEPOWcore
pkgincludedir = $(includedir)/PEPEPOWcore
pkglibdir = $(libdir)/PEPEPOWcore
pkglibexecdir = $(libexecdir)/PEPEPOWcore
...
CONFIG_HEADER = $(top_builddir)/src/config/PEPEPOW-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/PEPEPOW-config.h.in \
...
ACLOCAL = ${SHELL} '/home/runner/work/PePe-core/PePe-core/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARM_CRC_CXXFLAGS = 
ARM_SHANI_CXXFLAGS = 
AUTOCONF = ${SHELL} '/home/runner/work/PePe-core/PePe-core/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/home/runner/work/PePe-core/PePe-core/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/home/runner/work/PePe-core/PePe-core/build-aux/missing' automake-1.16
...
CXXFLAGS = -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wno-implicit-fallthrough
CYGPATH_W = echo
DEBUG_CPPFLAGS = 
DEBUG_CXXFLAGS = 
DEFS = -DHAVE_CONFIG_H
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} '/home/runner/work/PePe-core/PePe-core/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = PEPEPOWcore
PACKAGE_BUGREPORT = https://github.com/MattF42/PePe-core/issues
PACKAGE_NAME = PEPEPOW Core
PACKAGE_STRING = PEPEPOW Core 2.7.1
PACKAGE_TARNAME = PEPEPOWcore
PACKAGE_URL = 
...
X11XCB_CFLAGS = 
X11XCB_LIBS = 
X86_SHANI_CXXFLAGS = -msse4 -msha -maes
XGETTEXT = 
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/runner/work/PePe-core/PePe-core
abs_srcdir = /home/runner/work/PePe-core/PePe-core
abs_top_builddir = /home/runner/work/PePe-core/PePe-core
abs_top_srcdir = /home/runner/work/PePe-core/PePe-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/runner/work/PePe-core/PePe-core/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/PEPEPOWd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/PEPEPOW_qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/PEPEPOW-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = PEPEPOW-Qt.app
OSX_DMG = PEPEPOW-Core.dmg
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/PEPEPOW-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/PEPEPOW-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/PEPEPOW-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/PEPEPOW-config.h
$(top_srcdir)/src/config/PEPEPOW-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/PEPEPOW-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/PEPEPOW-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/PEPEPOW-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "PEPEPOW-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/PEPEPOW-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
